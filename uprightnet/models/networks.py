...
class JointLoss(nn.Module):
    ...
    def get_rp_prediction(self, pred_cam_geo_unit, 
        ...
        [pred_roll, pred_pitch] = decompose_up_n(est_up_n.cpu().numpy()) # rad
        [gt_roll, gt_pitch] = decompose_up_n(gt_up_vector[i, :].cpu().numpy()) # rad
        
        return pred_roll, pred_pitch, gt_roll, gt_pitch, est_up_n.cpu().numpy(), gt_up_vector[i, :].cpu().numpy(), 
